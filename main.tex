...
\centering
\begin{syntax}
M.1 \DefEq \RecSigma {\rho[z\co\SigmaTy {x\co\sigma} \tau]} {x[x\co\sigma,y\co\tau]}{M} : \sigma\\\\
M.2 \DefEq \RecSigma {\Subst{x}{z.1}\rho[z\co\SigmaTy {x\co\sigma} \tau]} {y[x\co\sigma,y\co\tau]} {M} : \Subst{x} {M.1} \tau
\end{syntax}
